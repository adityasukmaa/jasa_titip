        ...
        <div class="modal-content">
            <div class="modal-header bg-warning">
                <h4 class="modal-title">
                    <i class="fas fa-pencil-alt mr-2"></i> Update Data Setting
                </h4>
            ...
            <div class="modal-body">
                ...
                <x-adminlte-input name="value" label="Value" placeholder="Value"  wire:model="value">
