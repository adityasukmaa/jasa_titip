    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Apakah anda yakin akan menghapus data Product<span style="font-weight: 600"> {{$name}} </span>
            </div>
            <div class="modal-footer">
                <x-adminlte-button label="Batal" theme="primary" wire:click="$set('show', 'hidden')"/>
                <button type="button" class="btn btn-default bg-danger" data-dismiss="modal" wire:click="destroy({{$product_id}})">
                    Hapus 
                </button>
            </div>
        </div>
